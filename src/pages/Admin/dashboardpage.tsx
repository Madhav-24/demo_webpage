...
/**
 * Dashboard shell that owns navigation and the shared camera collection.
 * Keeping camera state here allows the add-camera and camera-list pages to
 * stay synchronized while the user moves between dashboard sections.
 */
export function DashboardPage({ onLogout }: DashboardPageProps) {
  ...
  /** Add a camera with a client-generated identifier for this session. */
...
/** Renders the static progress visualization used by the overview panel. */
